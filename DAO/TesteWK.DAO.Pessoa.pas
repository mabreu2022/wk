...
function TDAOPessoa.Inserir(aPessoa: TPessoa): Boolean;
var
   QryPessoa : TFDQuery;
...
function TDAOPessoa.PesquisaId(aTabela, aId: String): Integer;
var
  Qry: TFDQuery;
  Conexao: TConnection;
begin
...
//    Qry.ParamByName('aTabela').AsString := aTabela;
    ...
    Qry.Open;
    Showmessage('O IdPessoa é : ' + Qry.Fields[0].Text);
...
function TDAOPessoa.PesquisaIdEndereco(aTabela, aIdEndereco: string): Integer;
var
  Qry: TFDQuery;
  Conexao: TConnection;
begin
